...
export type ProgramSkillsValues = {
  haveProgramSkills: { id: number; answer: string };
    ...
    >
      <div className="space-y-5">
        <Select
          ...
          value={formData?.haveProgramSkills?.answer}
        />
        <Select
        ...
        {formData.whichProgram.answer && (
          <div className="space-y-2">
            <label className="pl-2">{formData.whichProgram.answer + " " +questions?.[2]?.question_title}*</label>
        ...
        {formData.whichLang.answer && (
          <div className="space-y-2">
            <label className="pl-2">{formData.whichLang.answer + " " + questions?.[4]?.question_title}*</label>
            <div className="flex gap-5">
